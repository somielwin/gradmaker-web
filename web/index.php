	...
	<section id="main-wrapper">
            ...
            <div class="container">
                ...
                <div class="pt-computation-wrap">
                    <div class="col-wrap project-detail-wrap fl">
                        ...
                        <div class="cc-box">
                            <p>*Calculations are based on the estimated average of the university's current tuition fee then adds 10% for each year. Historically, tuiton fee increase is around 8-10% yearly.</p>
                        </div>
                    </div>
                    <div class="col-wrap projected-tuition fr">
                        <div class="pt-box">
                            ...
                            <p class="text-center">
                                <br>
                                Source: <a href="http://www.finduniversity.ph/">FindUniversity.ph</a>
                            </p>
                            
                        </div>
                        <span class="pt-info">For your child from  <span id="pj-year">2035-2038</span></span>
                ...
                <div class="comparison-wrap">
                    ...
                    <div class="compa-graph col-wrap fl">
                        <div class="flex flex-row">
                            <figure>
                            	<a href="#" class="placeholder-video play-video" data-videoid="n9kVfCspfg0">
        ...
        <section id="section6" class="sec-wrap section4 bg-grey jq-section">
            <div class="container">
                <div class="comparison-wrap">
                    <div class="compa-content col-wrap fr animated hiding" data-animation="fadeInUp">
                        <h2>GradMaker <small>vs</small> <br>Savings Account</h2>
                    ...
                    <div class="col-wrap investment-graph fr">
                        <div class="ii-tab-wrapv2">
                            <div class="ii-tab-item active" id="pay-if-forward" >
                                ...
                                <p><small>For every GradMaker investment you make 1% is matched by Manulife <br>to be donated to <a href="http://cartwheelfoundation.org/" target="_blank">Cartwheel Foundation</a>.</small></p>
		...
		<section id="section9" class="sec-wrap section7 bg-green jq-section">
			...
			<figure class="icon-download"><img src="images/home/icon-download.svg" alt=""></figure>
				<div class="act-now">
					<div class="sec-head-title text-center animated hiding" data-animation="fadeInUp">
						<h2>Download the <br class="mb">app now!</h2>
...
<footer>
    ...
    <div class="container">
        ...
        <p class="copyright">Copyright © 2017, The Manufacturers Life Insurance Company and its subsidiaries. All rights reserved.</p>
	...
	$(document).ready(function () {
		...
		$(document).on('click', '.faq-list-home h4', function(e){
            ...
            if($(this).closest('li').hasClass('active')) {
                ...
                $(this).siblings('.fl-h').stop(true, false).slideUp(300);
            } else {
