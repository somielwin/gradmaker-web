...
<section id="main-container">
    ...
    <section id="main-wrapper">
        ...
        <section class="sec-wrap bg-grey jq-section">
            <div class="container">
                <div class="sec-head-title text-center animated hiding" data-animation="fadeInUp">
                    ...
                    <div class="col-wrap investment-graph fr">
                        <div class="ii-tab-wrapv2">
                            ...
                            <div class="ii-tab-item" id="product" >
                                <figure><img class="lazyload-trigger" src="images/version2/tab-product.png" data-src="images/version2/tab-product.png" alt=""></figure>
            ...
            <div class="container">
                ...
                <div class="get-early-access">
                    <div class="get-access-title">
                        ...
                        <h6>Be one of the first to experience mobile investing.</h6>
                        <p>* Once the app is live, it will only be available for download in the Philippines. <img src="images/version2/ph_flag_ai_big.png"></p>
                        <p>GradMaker will be available on Samsung S6 and up with Android version 6.0 and up &amp; iPhone 6 and up with iOS version 10 and up.</p>
                    </div>
    ...
    <div class="top-footer">
        ...
        <div class="container">
            <ul>
                ...
                <li><a href="#" target="_blank">Product &amp; Solutions</a></li>
